...
PRS_pheno_file <- '/scratch/user/uqjjian3/CVD_Psych_PRS_project/63_checkpoint_24Aug2022/5_Assembling_PRS_pheno/UKB_CVD_and_psych_pheno_PRS_covariates.txt'
...
running_glm <- function(in_outcome, in_predictor, in_predictor_str, in_sex, in_cohort, in_PRS_pheno_file, in_subdir) {
	...
	### Filtering to retain screened control individuals if necessary
