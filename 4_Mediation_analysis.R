...
covariates_noBMI <- c('recruitment_age', 'array', 'baseline_smoked_ever', 'PC1', 'PC2', 'PC3', 'PC4', 'PC5', 'PC6', 'PC7', 'PC8', 'PC9', 'PC10', 'PC11', 'PC12', 'PC13', 'PC14', 'PC15', 'PC16', 'PC17', 'PC18', 'PC19', 'PC20')
covariates_withBMI <- c('baseline_BMI', 'recruitment_age', 'array', 'baseline_smoked_ever', 'PC1', 'PC2', 'PC3', 'PC4', 'PC5', 'PC6', 'PC7', 'PC8', 'PC9', 'PC10', 'PC11', 'PC12', 'PC13', 'PC14', 'PC15', 'PC16', 'PC17', 'PC18', 'PC19', 'PC20')

if (in_risk_factor == 'baseline_BMI' | in_outcome == 'baseline_BMI'){
	in_covariates_c <- covariates_noBMI
} else {
	in_covariates_c <- covariates_withBMI
}
...
# Filter for sex
sex_pheno_PRS_df <- curr_PRS_pheno_df[which(filtering), ] # apply the necessary filtering steps for the sex of interest
...
if (in_outcome == 'baseline_BMI'){
	PRS_CVD_association <- lm(PRS_CVD_formula, data = sex_pheno_PRS_df)
} else {
...
if (in_outcome == 'baseline_BMI'){
	Predictor_outome_association <- lm(Predictor_outome_formula, data = sex_pheno_PRS_df)
} else {
